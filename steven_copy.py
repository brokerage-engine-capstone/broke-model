...
df.com_plan.value_counts()

df['com_percent'] = df.com_gross / df.sale_amount

df.groupby('com_plan')['com_percent'].mean()*100

df['com_gross'] = df.com_gross.fillna(df.sale_amount * .025)
...
agent_df.sort_values('avg_agent_com')
